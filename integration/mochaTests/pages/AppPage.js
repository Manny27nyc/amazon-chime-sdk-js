...
class AppPage {
  ...
  async clickMicrophoneButton() {
    await this.driver.wait(until.elementIsVisible(this.driver.findElement(elements.microphoneButton))).click();
  }
  ...
  async clickOnMicrophoneDropdownButton() {
    await this.driver.findElement(elements.microphoneDropDownButton).click();
  ...
  async playRandomTone()  {
    ...
    await this.driver.findElement(elements.microphoneDropDown440HzButton).click();
  }
